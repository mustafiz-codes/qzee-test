  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-2">
        <div className="primary-bg rounded-md p-6">
          <img src={Qzee} alt="qzee" />
          <h2 className="my-4">Members in the queue</h2>
          <p className="font-bold">30</p>
        </div>
        <div className="primary-bg rounded-md p-6">
          <img src={Calender} alt="Calender" />
          <h2 className="my-4">Bookings today</h2>
          <p className="font-bold">30</p>
        </div>
      </div>
      <div className="my-6 theme-bg rounded-md p-6 h-[150px]">
        <img src={Users} alt="" />
